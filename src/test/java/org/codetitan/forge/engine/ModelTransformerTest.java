...
import org.codetitan.forge.engine.ModelTransformer;
import org.codetitan.forge.engine.TransformException;
import org.codetitan.forge.model.*;
...
public class ModelTransformerTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        school.addAssociation(Multiplicity.OneToMany, dept, "child", "parent", true);
        dept.addAssociation(Multiplicity.OneToMany, school, "parent", "child", false);
        ...
        course.addAssociation(Multiplicity.ManyToOne, instr);
        ...
        school.addAssociation(Multiplicity.ManyToMany, student, true);
        student.addAssociation(Multiplicity.ManyToMany, school);
        ...
        student.addAssociation(Multiplicity.OneToOne, user, true);
        user.addAssociation(Multiplicity.OneToOne, student);
