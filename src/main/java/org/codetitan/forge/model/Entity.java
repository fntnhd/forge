...
public class Entity extends Type {
    ...
    private Map<Multiplicity, List<Association>> associations;
    ...
    public Map<Multiplicity, List<Association>> getAssociations() {
        if (associations == null) {
            associations = new HashMap<Multiplicity, List<Association>>();
        }
        return associations;
    }

    public List<Association> getAssociations(Multiplicity multiplicity) {
    ...
    public List<Association> getOneToMany() {
        return getAssociations(Multiplicity.OneToMany);
    }

    public List<Association> getOneToOne() {
        return getAssociations(Multiplicity.OneToOne);
    }

    public List<Association> getManyToMany() {
        return getAssociations(Multiplicity.ManyToMany);
    }

    public List<Association> getManyToOne() {
        return getAssociations(Multiplicity.ManyToOne);
    }
    ...
    public void addAssociation(Multiplicity multiplicity, Entity entity, String name, String role, boolean owner) {
    ...
    public void addAssociation(Multiplicity multiplicity, Entity entity, boolean owner) {
        addAssociation(multiplicity, entity, null, null, owner);
    }

    public void addAssociation(Multiplicity multiplicity, Entity entity) {
